...
<head>
    ...
    <title>Spirale Infosoft || About</title>
    <?php require_once './_partials/_styles.php' ?>
...
<body>
    ...
    <main class="about-page style-5">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="info">
                            ...
                            <p>
                                A perfect fusion of technology and creativity
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row align-items-center justify-content-between">
                        <div class="col-lg-4 order-2 order-lg-0">
                            <div class="section-head mb-30 style-5">
                                <h2><span> Spirale</span>infosoft <span> Philosophy </span> </h2>
                            </div>
                            <p>
                                s tech pvt ltd is a leading software development and service providing company since 2009, offering a wide range of software development and maintenance services across the globe.
                    ...
                    <div class="col-lg-4">
                        <div class="info">
                            ...
                            <div class="text mb-50 fs-12px color-666">
                                With s tech pvt ltd Marketplace, choose from hundreds of payment gateways for your customers.
                            </div>
                            <ul>
                            ...
                            <a href="page-services-5.html" class="btn rounded-pill blue5-3Dbutn hover-blue2 sm-butn fw-bold mt-60 px-5"><b>See all Services</b>
                                <a href="./index.php#"></a>
                            </a>
                        </div>
                    </div>
        ...
        <section class="clients section-padding style-5">
            <div class="section-head text-center mb-40 style-5">
                <h2 class="mb-20">These numbers shows <span>our years </span><br>of experience and expertise </h2>
            </div>
            <div class="content">
                    ...
                    <div class="swiper-container">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <a href="#" class="img">
                                    <img src="assets/img/about-image/1.webp" alt="">
                                </a>
                            </div>
                            <div class="swiper-slide">
                                <a href="#" class="img">
                                    <img src="assets/img/about-image/2.jpg" alt="">
                                </a>
                            </div>
                            <div class="swiper-slide">
                                <a href="#" class="img">
                                    <img src="assets/img/about-image/3.png" alt="">
                                </a>
                            </div>
                            <div class="swiper-slide">
                                <a href="#" class="img">
                                    <img src="assets/img/about-image/4.png" alt="">
                                </a>
                            </div>
                            <div class="swiper-slide">
                                <a href="#" class="img">
                                    <img src="assets/img/about-image/5.png" alt="">
                                </a>
                            </div>
                            <div class="swiper-slide">
                                <a href="#" class="img">
                                    <img src="assets/img/about-image/6.webp" alt="">
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="clients-slider5" dir="rtl">
                    <div class="swiper-container">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <a href="#" class="img">
                                    <img src="assets/img/about-image/7.webp" alt="">
                                </a>
                            </div>
                            <div class="swiper-slide">
                                <a href="#" class="img">
                                    <img src="assets/img/about-image/8.png" alt="">
                                </a>
                            </div>
                            <div class="swiper-slide">
                                <a href="#" class="img">
                            ...
                            <div class="swiper-slide">
                                <a href="#" class="img">
                                    <img src="assets/img/about-image/10.png" alt="">
                                </a>
                            </div>
                            <div class="swiper-slide">
                                <a href="#" class="img">
                                    <img src="assets/img/about-image/11.png" alt="">
                                </a>
                            </div>
                            <div class="swiper-slide">
                                <a href="#" class="img">
                                    <img src="assets/img/about-image/12.png" alt="">
                                </a>
                            </div>
                        </div>
                    </div>
...
<!-- Mirrored from iteck-html.themescamp.com/about.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 17 May 2023 06:20:01 GMT -->
